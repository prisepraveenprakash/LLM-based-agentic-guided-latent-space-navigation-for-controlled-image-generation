...
## Web UI (Dropdown Controls)

You can launch a local frontend with dropdowns for facial attribute and intensity:
...
Features:
- Dropdowns for attribute and intensity.
- A live progress bar while editing runs.
- Dataset face selector with index `0-99`.
- Input Face preview updates immediately when a new dataset face is selected.
